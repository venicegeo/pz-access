...
//    @Test
//    public void testForCoverage1() {
//        Mockito.when(this.restTemplate.exchange(
//                Mockito.anyString(),
//                Mockito.any(HttpMethod.class),
//                Mockito.any(),
//                Mockito.eq(String.class)))
//                .thenReturn(new ResponseEntity<String>("", HttpStatus.NOT_FOUND)) //workspace does not exist
//                .thenThrow(new HttpClientErrorException(HttpStatus.NOT_FOUND)) //exception creating workspace
//                .thenReturn(new ResponseEntity<String>("", HttpStatus.NOT_FOUND)) //datastore does not exist
//                .thenThrow(new HttpClientErrorException(HttpStatus.NOT_FOUND)); //exception creating datastore
//
//        piazzaEnvironment.initializeEnvironment();
//        assertTrue(true); // no error occurred
//    }
...
//                Mockito.any(),
//                Mockito.eq(String.class)))
//                .thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR)) //workspace does not exist
//                .thenThrow(new HttpClientErrorException(HttpStatus.NOT_FOUND)) //exception creating workspace
//                .thenThrow(new HttpClientErrorException(HttpStatus.NOT_FOUND)) //datastore does not exist
//                .thenThrow(new HttpClientErrorException(HttpStatus.NOT_FOUND)); //exception creating datastore
//
//        piazzaEnvironment.initializeEnvironment();
//        assertTrue(true); // no error occurred
